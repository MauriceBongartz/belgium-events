...
export default function EventCard({ event, index = 0 }: EventCardProps) {
  ...
  return (
    <Link href={`/event/${event.id}`} className="block group">
      <article
        className="event-card card opacity-0 animate-fade-up cursor-pointer overflow-hidden p-0"
      ...
      >
        ...
        {event.image_url ? (
          ...
          <div className="w-full h-48 bg-belgium-card border-b border-belgium-border flex items-center justify-center">
